...
Scheme
{
	...
	BaseSettings
	{
		...
		MessageDialog.MatchmakingBG			"46 46 46 255"	[$X360]
		MessageDialog.MatchmakingBGBlack			"22 22 22 255"	[$X360]
		
		MatchmakingMenuItemTitleColor			"255 255 255 255"	[$X360]
		MatchmakingMenuItemDescriptionColor		"255 255 255 255"	[$X360]
	}
	...
	Fonts
	{
		...
		"DefaultFixedOutline"
		{
			"1"
			{
				"name"		"IBM Plex Sans Regular" [!$OSX]
...
//			}
	...
	CustomFontFiles
	{
		...
		"2"		{	"font" "resource/fonts/IBM Plex Sans Regular.ttf"	"name"	"IBM Plex Sans Regular"	}
	}
}
